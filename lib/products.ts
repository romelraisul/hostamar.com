...
export const PRODUCTS: Product[] = [
  {
    ...
    gradient: 'from-[#0E7C3A] via-[#0c6a32] to-[#0F172A]',
    badge: 'Beta',
    status: 'beta',
  ...
  },
  {
    ...
    gradient: 'from-[#2563EB] via-[#0EA5E9] to-[#0F172A]',
    badge: 'Beta',
    status: 'beta',
  ...
  },
  {
    ...
    gradient: 'from-[#2563EB]/80 via-[#2563EB] to-[#0F172A]',
    badge: 'Beta',
    status: 'beta',
  ...
  },
  {
    ...
    gradient: 'from-[#2563EB]/60 via-[#64748B] to-[#0F172A]',
    badge: 'Beta',
    status: 'beta',
