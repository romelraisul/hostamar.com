    ...
    <section id="features" className="py-20 bg-transparent">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-slate-800 p-8 rounded-xl border border-gray-200 dark:border-slate-700 hover:shadow-lg dark:hover:shadow-slate-700/50 transition-all">            <div className="w-12 h-12 bg-[#0E7C3A] dark:bg-green-900/40 rounded-lg flex items-center justify-center mb-4">
