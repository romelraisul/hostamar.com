...
const GH = 'https://github.com/romelraisul/hostamar.com/releases/download/v0.1.5'
const ROWS = [
  ...
  { os: 'Android', file: 'Hostamar-Node.apk', size: 'pending', href: 'https://github.com/romelraisul/hostamar.com/releases/tag/v0.1.4', alt: null },
          ...
          <tbody className="divide-y">
            {ROWS.map(r=>(
              <tr key={r.file} className="hover:bg-[#F8FAFC]">
                ...
                <td className="px-4 py-3">v0.1.5</td>
