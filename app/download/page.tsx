...
const GH = 'https://github.com/romelraisul/hostamar.com/releases/download/v0.1.13'
const ROWS = [
  ...
  { os: 'Android', file: 'Hostamar-Node.apk', size: '50 MB', href: `${GH}/Hostamar-Node.apk`, alt: null },
  { os: 'iOS', file: 'Hostamar-Node.ipa', size: '40 MB', href: `${GH}/Hostamar-Node.ipa`, alt: 'TestFlight' },
]
          ...
          <tbody className="divide-y">
            {ROWS.map(r=>(
              <tr key={r.file} className="hover:bg-[#F8FAFC]">
                ...
                <td className="px-4 py-3">v0.1.13</td>
