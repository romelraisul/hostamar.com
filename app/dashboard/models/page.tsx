  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      ...
      <div className="mt-6 grid gap-2 md:grid-cols-3">
        <div className="rounded-xl border bg-[#FFFDF6] p-3"><h3 className="font-semibold text-sm">Tier S Reasoning</h3><p className="text-xs text-slate-600">kimi-k3 1M • deepseek-v4 1.3M • Thinking</p></div>
        <div className="rounded-xl border bg-[#FFFDF6] p-3"><h3 className="font-semibold text-sm">Tier A Long Context</h3><p className="text-xs text-slate-600">longcat 1,048,756 • x-preview 1,048,576 • gemini 1M • ox-alpha PONG</p></div>
        <div className="rounded-xl border bg-[#FFFDF6] p-3"><h3 className="font-semibold text-sm">Tier B Balanced</h3><p className="text-xs text-slate-600">512K-256K • fast & cheap • 0.03-0.09 Taka/msg</p></div>
      </div>
    </div>
  )
}