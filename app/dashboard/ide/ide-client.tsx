...
export default function IdeClient() {
  ...
  const create = async (type: string) => {
    ...
    try {
      ...
      setMsg(`✅ ${data.type} IDE চালু (${data.serverId}) — ${data.creditsPerHour}cr/ঘণ্টা`)
      await load()
    ...
    <div className="mx-auto max-w-7xl p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-500">ব্রাউজারে সফটওয়্যার বানান — ফাইল B2-তে সেভ, কোড রান — ক্রেডিট প্রতি ঘণ্টা</p>
        </div>
