        ...
        <section className="mt-8 rounded-2xl border border-zinc-200 bg-white p-6">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-xl border-2 border-[#0E7C3A] p-4">
              ...
              <p className="mt-1 text-2xl font-bold">৳990<span className="text-sm font-normal text-zinc-500">/mo</span></p>
              <ul className="mt-3 space-y-1 text-sm text-zinc-600">
            ...
            <div className="rounded-xl border border-zinc-200 p-4">
              ...
              <p className="mt-1 text-2xl font-bold">৳2,900<span className="text-sm font-normal text-zinc-500">/mo</span></p>
              <ul className="mt-3 space-y-1 text-sm text-zinc-600">
