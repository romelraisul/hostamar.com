...
export default function ProjectsPageClient() {
  ...
  return (
    ...
    >
      <Link href="/ossu/curriculum">{t('ossu.backToCurriculum')}</Link>

      <h1 style={{ marginTop: '1rem' }}>🎯 {t('ossu.projectsTitle')}</h1>
      <p style={{ color: '#666' }}>{t('ossu.projectsDesc')}</p>
