...
const routes: { path: string; changeFrequency: MetadataRoute.Sitemap[number]['changeFrequency']; priority: number }[] = [
  ...
  { path: '/coinlab/coin/bnb', changeFrequency: 'weekly', priority: 0.7 },
  { path: '/coinlab/coin/solana', changeFrequency: 'weekly', priority: 0.7 },
  { path: '/coinlab/coin/xrp', changeFrequency: 'weekly', priority: 0.7 },
  { path: '/coinlab/coin/cardano', changeFrequency: 'weekly', priority: 0.7 },
  { path: '/coinlab/coin/dogecoin', changeFrequency: 'weekly', priority: 0.7 },
  { path: '/coinlab/coin/tron', changeFrequency: 'weekly', priority: 0.7 },
