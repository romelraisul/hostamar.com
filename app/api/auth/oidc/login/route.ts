// GET /api/auth/oidc/login?tenant=acme-corp
// IdP-initiated / direct OIDC login entry. Mirrors SAML login: resolves the
// active OIDC connection and redirects to the IdP authorize URL.
