...
const TICKER = [
  'Slot — বিকাশ এন্ট্রি • BD server 20ms',
  'Roulette — শীঘ্রই',
  'Blackjack — শীঘ্রই',
  'Poker — শীঘ্রই',
...
const FEATURES = [
  ...
  { icon: Trophy, t: 'সাপ্তাহিক লিডারবোর্ড', d: 'সপ্তাহিক র‍্যাঙ্ক — বাংলাদেশের সেরা গেমার।' },
  { icon: Zap, t: 'ডাউনলোড ছাড়াই', d: 'HTML5 browser game — install ঝামেলা নেই।' },
]
    ...
    <div className="min-h-screen bg-[#FCFCF9] text-zinc-900 antialiased">
      ...
      <div className="mx-auto max-w-[1240px] px-4 md:px-6">
        <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-[13px] font-medium text-[#0E7C3A]">
          <span className="flex items-center gap-1.5"><Gauge className="w-4 h-4" /> বিডি সার্ভার ২০মি.সে.</span>
          <span className="flex items-center gap-1.5"><Banknote className="w-4 h-4" /> বিকাশ ইনস্ট্যান্ট পেআউট</span>
          <span className="flex items-center gap-1.5"><Zap className="w-4 h-4" /> ডাউনলোড ছাড়াই</span>
        </div>
      </div>
            ...
            const card = (
              <div className="rounded-2xl bg-white border border-zinc-200 p-5 flex flex-col h-full">
                ...
                <div className="mt-3 flex items-center gap-2 flex-wrap">
                  <span className="text-[11px] px-2 py-0.5 rounded-full bg-[#0E7C3A]/10 text-[#0E7C3A] font-medium">বিকাশ এন্ট্রি</span>
                  <span className="text-[11px] px-2 py-0.5 rounded-full bg-zinc-100 text-zinc-500">HTML5 · ডাউনলোড ছাড়াই</span>
                </div>
                <div className="mt-4">
                  {playable ? (
      ...
      {/* Leaderboard */}
      <section className="mx-auto max-w-[1240px] px-4 md:px-6 pb-12">
        <h2 className="text-[22px] md:text-[26px] font-bold mb-5">সাপ্তাহিক লিডারবোর্ড</h2>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              ...
              <p className="bangla text-[14px] text-zinc-300 mt-1 leading-[1.6]">
                Free browse · বিকাশ এন্ট্রি · টুর্নামেন্টে ফি স্পষ্ট থাকে।
                <br />
      ...
      <section className="mx-auto max-w-[1240px] px-4 md:px-6 pb-12">
        <div className="rounded-2xl border border-amber-300 bg-amber-50 p-5 flex items-start gap-3">
          ...
          <div>
            <div className="text-[15px] font-semibold">ফেয়ার প্লে • ১৮+</div>
