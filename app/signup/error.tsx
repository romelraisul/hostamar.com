  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-900">
      <div className="max-w-md rounded-lg border border-slate-700 bg-slate-800 p-8 text-center">
        ...
        <h2 className="mb-2 text-xl font-semibold text-white">Signup Error</h2>
        <p className="mb-6 text-sm text-slate-400">{error.message || 'Something went wrong'}</p>
        <div className="flex justify-center gap-4">
          <button
            onClick={() => reset()}
            className="rounded-md bg-[#0E7C3A] px-4 py-2 text-sm font-medium text-white hover:bg-[#0c6a32]"
          >
            Try Again
          </button>
          <a
