  ...
  return (
    <div className="space-y-6">
      <header>
        ...
        <p className="text-sm text-[#B8AFA3]">Completion: {ok}/{components.length} ({pct}%) — Updated: live</p>
      </header>
      ...
      <section className="grid gap-3 sm:grid-cols-4">
        <div className="rounded-lg bg-[#FFFDF6] p-4 text-center ring-1 ring-[#D8CDB4]">
          ...
          <div className="text-xs text-[#B8AFA3]">Operational</div>
        </div>
        <div className="rounded-lg bg-[#FFFDF6] p-4 text-center ring-1 ring-[#D8CDB4]">
          <div className="text-3xl font-bold text-[#0E7C3A]">{ok}</div>
          <div className="text-xs text-[#B8AFA3]">Healthy</div>
        </div>
        <div className="rounded-lg bg-[#FFFDF6] p-4 text-center ring-1 ring-[#D8CDB4]">
          <div className="text-3xl font-bold text-amber-600">{warn}</div>
          <div className="text-xs text-[#B8AFA3]">Needs Attention</div>
        </div>
        <div className="rounded-lg bg-[#FFFDF6] p-4 text-center ring-1 ring-[#D8CDB4]">
          <div className="text-3xl font-bold text-[#B8AFA3]">{components.length}</div>
          <div className="text-xs text-[#B8AFA3]">Total Components</div>
        </div>
      </section>
      ...
      <section className="rounded-xl bg-[#FFFDF6] p-4 shadow-sm ring-1 ring-[#D8CDB4]">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[#D8CDB4] text-left text-xs text-[#B8AFA3]">
            ...
            <tbody>
              {components.map((c, i) => (
                <tr key={i} className="border-b border-[#D8CDB4]/50">
                  ...
                  <td className="py-2 pr-4 text-xs text-[#B8AFA3]">{c.detail}</td>
