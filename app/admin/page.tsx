...
export default function AdminDashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      else if (ordersData.data) setOrders(ordersData.data)
      if (servicesData.services) setServices(servicesData.services)
      else if (servicesData.data) setServices(servicesData.data)
      if (subscriptionsData.subscriptions) setSubscriptions(subscriptionsData.subscriptions)
      else if (subscriptionsData.data) setSubscriptions(subscriptionsData.data)
      if (paymentsData.payments) setPayments(paymentsData.payments)
      else if (paymentsData.data) setPayments(paymentsData.data)
