  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        <div className="text-xs tracking-[0.2em] text-[#57534E]">OPS KPIs</div>
        <button onClick={onRefresh} className="px-2.5 py-1.5 rounded-lg bg-[#FDF8EC] border border-[#D8CDB4] text-xs text-[#57534E] hover:border-[#10B981]/30 flex items-center gap-1.5"><RefreshCw className="w-3.5 h-3.5"/>Refresh</button>
      </div>
