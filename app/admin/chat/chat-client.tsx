    ...
    <div className="flex h-[calc(100vh-64px)] bg-zinc-950 text-zinc-100">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="px-3 py-1.5 text-[10px] text-zinc-600 border-t border-zinc-900 flex gap-3">
          <span>⛓️ Conductor: hostamar-build 4mirik2jm → next (one-push)</span><span>•</span><span>B2 005a26c99e410200000000001 s3.us-east-005 ✅</span><span>•</span><span>TV 20 ✅ Storage 0/5GB</span>
        </div>
      </div>
