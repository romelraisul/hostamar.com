...
Android publishing: apps/mobile/android/app/build.gradle needs publishing singleVariant release inside android { } — reapply via scripts/fix-android-publishing.js after expo prebuild.
